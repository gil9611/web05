...
<form:form modelAttribute="goods" action="add" method="post">
	<table>
		...
		<tr>
			...
			<td id="gcategory2_td">
				<form:select id="gcategory2" path="gcategory2">
					<option value="">====선택====</option>
						<form:options items="${ccList2 }" itemLabel="cglabel" itemValue="cglabel" />
				</form:select>
				<form:errors cssStyle="color:deeppink; font-size:14px" path="gcategory2" />
			</td>
		</tr>
		<tr>
