		...
		<form:form action="${path1 }/member/join" method="post" modelAttribute="JoinMemberBean">
			<div class="form-group">
				...
				<div class="input-group">
					<form:input type="text" path="mid" class="form-control" onkeypress="resetExistMember()"/>
					<div class="input-group-append">
						<button type="button" class="btn btn-primary" onclick="checkExistMember()">중복확인</button>
					</div>
				</div>
				<form:errors path="mid" class="color:red; font-size:12px" />
			</div>
			<div class="form-group">
				<form:label path="mwd">비밀번호</form:label>
